...
public class CountryLearnApplication implements CommandLineRunner {
    ...
    private  void testDeleteCountry() {
        ...
        countryService.deleteCountry("JP"); // Assuming JP was added earlier

        try {
            countryService.findCountryByCode("JP"); // Should throw exception
        } catch (CountryNotFoundException e) {
            LOGGER.error("Country not found as expected after deletion!", e);
        }
    ...
    private  void testUpdateCountry() {
        ...
        try {
            countryService.updateCountry("IN", "Bharat"); // Example update
